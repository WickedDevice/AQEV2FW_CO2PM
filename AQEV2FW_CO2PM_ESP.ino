...
#define EEPROM_CO2_BASELINE_VOLTAGE_TABLE (EEPROM_NO2_BASELINE_VOLTAGE_TABLE - (5*sizeof(baseline_voltage_t))) // array of (up to) five structures for baseline offset characterization over temperature
#define EEPROM_MQTT_TOPIC_SUFFIX_ENABLED  (EEPROM_CO2_BASELINE_VOLTAGE_TABLE - 1)    // a simple flag to indicate whether or not the topic suffix is enabled
...
#define EEPROM_BACKUP_CO2_SENSITIVITY    (EEPROM_BACKUP_NO2_CAL_OFFSET + 4)
...
void initializeHardware(void) {
    ...
    Serial.println(F(" |       CO2 / PM Sensor Suite        |"));
